...
public class AssignmentSystem {
    ...
    public void initalizeFloors(int floors) {
        parkingFloors = new ParkingFloor[floors];
        for (int i = 0; i < floors; i++) {
            parkingFloors[i] = new ParkingFloor();
            parkingFloors[i].initializeBikeSpots(100);
            parkingFloors[i].initializeCarSpots(50);
            parkingFloors[i].initializeHandicappedSpots(5);
        }
    }
